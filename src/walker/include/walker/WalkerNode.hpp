...
class WalkerNode : public webots_ros2_driver::PluginInterface {
    public:
        ...
        /**
         * @brief Initializes Webots devices, publishers, subscribers, and initial State
    ...
    protected:
        ...
        class state_FORWARD : public States {
            public:
                 ...
                 * Transitions to TURNLEFT_State if obstacle detected and previous turn was right
                 * Transitions to TURNRIGHT_State if obstacle detected and previous turn was left
                 * Remains in FORWARD_State if no obstacle detected
